...
% BACK PROPOGATION
d3 = a_3 - y_matrix;                                             % has same dimensions as a3
d2 = (d3*Theta2).*[ones(size(z_2,1),1) sigmoidGradient(z_2)];     % has same dimensions as a2

D1 = d2(:,2:end)' * a_1;    % has same dimensions as Theta1
